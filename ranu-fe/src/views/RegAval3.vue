...
<v-container>
  <v-app-bar app color="primary" dark>
    ...
    <h1 class="font-weight-light" >Registo da 3ª Avaliação</h1>

<v-simple-table></v-simple-table>
<v-row>
    <v-col cols="12" md="6">
      <v-form class="ma-3" @submit.prevent="registerAval3()" ref="addForm"> 
        ...
        async registerAval3() {
            ...
            if (valid) {
              ...
              try {
                ...
                const res = await this.axios.post("http://localhost:3000/medico/avaliacao/terceira", this.add_aval);
